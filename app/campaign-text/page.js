  ...
  return (
    <div className="email-main">
      ...
      <div className="email-social">
        <p className="social-media-text"> Social Media Follow</p>
        <div className="col-12 col-s-12 email-social-icons">
          <svg
          ...
          >
            <a href="https://www.youtube.com/@EdgarLindo">
              <circle cx="20" cy="20" r="20" fill="transparent"></circle>
            </a>
          ...
          >
            <a href="https://www.facebook.com/theedgarlindo">
              <circle cx="18" cy="18" r="18" fill="transparent"></circle>
            </a>
      ...
      <div className="email-footer">
        ...
        <p className="email-footer-text">This email was sent to: email</p>
        <p className="email-footer-text">
